CLASS zcl_kk_es5agency DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_KK_ES5AGENCY IMPLEMENTATION.


  METHOD if_rap_query_provider~select.

  DATA:
      lt_business_data TYPE TABLE OF zkk_es5srv_con_agency=>tys_z_travel_agency_es_5_type,
         ...
         lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
           EXPORTING
              is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                                  proxy_model_id      = 'ZKK_ES5SRV_CON_AGENCY'
