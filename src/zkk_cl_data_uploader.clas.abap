*CLASS zkk_cl_data_uploader DEFINITION
*  PUBLIC
*  FINAL
*  CREATE PUBLIC .
*
...
*
*
*CLASS zkk_cl_data_uploader IMPLEMENTATION.
*
*
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zkk_table_bpa,
           lt_prod type table of zkk_db_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zkk_table_bpa from table @lt_bp.
     insert zkk_db_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zkk_dte_bpid,
           lt_so type table of zkk_db_sales_hdr,
           lt_so_i type table of zkk_db_so_item.
    ...
    select * from zkk_table_bpa into table @data(lt_bpa).
    select * from zkk_db_product into table @data(lt_prod).
    ...
    insert zkk_db_sales_hdr from table @lt_so.
    insert zkk_db_so_item from table @lt_so_i.

  ENDMETHOD.


  METHOD flush.
    delete from : zkk_table_bpa, zkk_db_product, zkk_db_sales_hdr, zkk_db_so_item.
  ENDMETHOD.
ENDCLASS.
